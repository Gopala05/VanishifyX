...
const Nav: React.FC<NavProps> = ({ show, className }) => {
  return (
    <header
      className={cn("bg-bgcolor fixed top-0 left-0 right-0 z-10", className)}
    >
      <div className="mx-auto flex h-28 max-w-screen-2xl items-center gap-8 px-4 sm:px-6 lg:px-8">
        <Link className="flex items-center gap-x-5 text-teal-600" href="/">
          <Image
            src="/Logo.png"
            alt="Logo"
            width={60}
